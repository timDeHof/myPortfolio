...
describe('githubAPI.fetchUser', () => {
  ...
  it('should fetch user information correctly', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/api/github/users/timDeHof');
...
describe('githubAPI.fetchRepositories', () => {
  ...
  it('should fetch and filter repositories correctly', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('/api/github/users/timDeHof/repos?sort=updated&per_page=100&type=all');
...
describe('githubAPI.fetchRepositoryLanguages', () => {
  ...
  it('should fetch repository languages correctly', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(`${GITHUB_API_BASE}/repos/timDeHof/my-showcase/languages`);
